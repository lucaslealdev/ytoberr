<a href="/videos/{{ $video->id }}" class="bg-gray-900 rounded-lg overflow-hidden border border-gray-800 hover:border-gray-700 transition duration-200 flex flex-col group shadow-lg">
    <!-- Video Thumbnail -->
