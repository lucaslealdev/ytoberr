<a href="/videos/{{ $video->id }}" class="bg-gray-900 p-4 rounded-lg shadow border border-gray-800 hover:border-gray-700 transition duration-200 flex items-center gap-4">
